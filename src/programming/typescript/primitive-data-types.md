...
Trong đó, `0b1010` và `0o744` là [cách biểu diễn số nhị phân và bát phân trong ES6][Binary and Octal Notation in ES6], chúng sẽ được biên dịch thành số thập phân.
...
Ở đây, <code>&#96;</code> được sử dụng để định nghĩa [chuỗi mẫu trong ES6][Template Strings in ES6], và `${expr}` được sử dụng để nhúng biểu thức trong chuỗi mẫu.
